...
import { User, ShoppingCart, ShieldCheck, Truck } from 'lucide-react';
...
export const RoleSelector = ({
  ...
  const getIcon = (iconName) => {
    switch (iconName) {
      ...
      case 'Truck': return <Truck className="w-4 h-4 shrink-0" />;
  ...
  return (
    <div className="w-full space-y-2 text-left">
      ...
      <div 
        role="tablist" 
        className="grid grid-cols-2 sm:grid-cols-4 gap-2 p-1.5 bg-slate-100 border border-slate-200 rounded-2xl"
      >
